...
let sliderSlider = new Swiper('.right__slider', {
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
const headerBg = document.querySelector('.header'),
	headerMenuBody = document.querySelector('.menu__body'),
	headerLogo = document.querySelector('.menu__logo'),
	headerList = document.querySelector('.menu__list'),
	headerLogoImage = document.querySelector('.menu__logo a img');
...
function scrollFunction() {
	if (document.body.scrollTop > 5 || document.documentElement.scrollTop > 5) {
		headerBg.classList.add('_header-scroll');
		headerMenuBody.classList.add('_body-scroll');
		headerLogo.classList.add('_logo-scroll');
		headerLogoImage.classList.add('_logo-img-scroll');
		headerLogoImage.classList.add('_logo-img-scroll');
		headerList.classList.add('_list-scroll');

	} else {

		if (headerBg.classList.contains('_header-scroll')) {
			headerBg.classList.remove('_header-scroll');
		}

		if (headerList.classList.contains('_list-scroll')) {
			headerList.classList.remove('_list-scroll');
		}

		if (headerMenuBody.classList.contains('_body-scroll')) {
			headerMenuBody.classList.remove('_body-scroll');
		}

		if (headerLogo.classList.contains('_logo-scroll')) {
			headerLogo.classList.remove('_logo-scroll');
		}

		if (headerLogoImage.classList.contains('_logo-img-scroll')) {
			headerLogoImage.classList.remove('_logo-img-scroll');
		}
	}
}
